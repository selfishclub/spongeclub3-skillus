...
Read this when executing a specific ASO task end to end — keyword research, metadata optimization, competitor analysis, app launch, or A/B testing — including the step-by-step procedures, scoring criteria, placement tables, structure diagrams, and worked before/after examples.
...
See: [references/aso-best-practices.md](aso-best-practices.md)
