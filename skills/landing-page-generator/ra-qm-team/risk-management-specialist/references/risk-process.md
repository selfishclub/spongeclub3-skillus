# ISO 14971 Risk Management Process — Workflows & Decision Frameworks

The end-to-end ISO 14971:2019 process: planning, analysis, evaluation, control, post-production
monitoring, plus the decision frameworks that drive each stage. Read this when executing any stage
of the risk management lifecycle or deciding how to treat a specific risk.
...
See: [risk-analysis-methods.md](risk-analysis-methods.md)
